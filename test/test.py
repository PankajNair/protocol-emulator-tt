...
#
# FLOW-VALIDATION ONLY: verbatim from github.com/urish/ttihp-sram-test
# (Apache-2.0), matches the SRAM-macro wiring temporarily in src/top.v.
# Not the real protocol emulator's test -- revert alongside top.v once
# this validation run lands.
